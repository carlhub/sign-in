...
# Visitors #
curl -d "name=asus T&email=asus@aol.com&phone=HiNumPh&company=carlox co&isOfficialVisit=false&isEscortRequired=false&escortName=ProEscortFakeNametrue" -X POST http://127.0.0.1:3000/visitors/register

curl -d "name=Carlos&email=carlos@aol.com&phone=6265555555&company=carloxOffice&isOfficialVisit=false&isEscortRequired=false&escortName=DominguezEscortPolice" -X POST http://127.0.0.1:3000/visitors/register
